...
// All departments get the same subDepartments
const subDepartmentsMap: { [key: number]: { id: number; name_en: string; name_hi: string }[] } = {};
for (let i = 1; i <= 49; i++) {
  subDepartmentsMap[i] = subDepartments;
}
